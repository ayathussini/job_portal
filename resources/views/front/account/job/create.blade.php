...
@endif
            <form action="" method="pose" id="craeteJobForm" name="craeteJobForm">
                 @csrf
                @method('post')
                <div class="card border-0 shadow mb-4">
                       <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select" name="jobType" id="jobType">
                                    <option value="">Selecte Job Nature</option>
                        ...
                        <div class="mb-4">
                          ...
                          <div class="mb-4">
                            <label for="" class="mb-2">Responsabilites<span class="req">*</span></label>
                            <textarea class="textarea" name="responsabilites" id="responsabilites" cols="5" rows="5" placeholder="Responsabilites"></textarea>
                            <p class="invalid-feedback"></p>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Qualifications<span class="req">*</span></label>
                            <textarea class="textarea" name="qualifications" id="qualifciations" cols="5" rows="5" placeholder="Qualifications"></textarea>
                            <p class="invalid-feedback"></p>
                        </div>
                        <div class="mb-4">
...
@section('customJs')
<script>
    $('#craeteJobForm').submit(function(e){
        e.preventDefault();
        ...
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            data :$('#craeteJobForm').serializeArray(),
            success:function(response){
                ...
                if(response.status == true){
                    ...
                    if(errors.responsabilite){
                        $("#responsabilites").addClass('is-invalid')
                        .siblings('p')
                        .addClass('invalid-feedback')
                        .html(errors.responsabilites[0])
                    }else{
                        $("#responsabilites").removeClass('is-invalid')
                        .siblings('p')
                        .removeClass('invalid-feedback')
                        .html('')
                    }
