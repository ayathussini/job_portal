                            ...
                            <table class="table">
                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr class="active">
                                        ...
                                        <td>{{ \carbon\Carbon::parse($jobApplication->job->applied_date)->format('d M, Y') }}</td>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="{{ route('jobDetail', $jobApplication->job->id) }}"><i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
                                                    <li>
                                                        <a class="dropdown-item" href="javascript:void(0)" onclick="removeJob({{ $jobApplication->id }})">
