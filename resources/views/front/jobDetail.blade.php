           ...
           @endif
                <div class="card shadow border-0">
                    ...
                    <div class="descript_wrap white-bg">    
                            ...
                            @if(!empty($job->responsabilites )) 
                            <div class="single_wrap">
                            <h4>Responsibility</h4>
                            <ul>
                                 {!! nl2br($job->responsabilites) !!} 
                            </ul>
                            </div>
                            @endif
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @else
                                <a href="{{route('account.login')}}" class="btn btn-secondary ">Login To Sava</a>
                            @endif
                    ...
                    <div class="descript_wrap white-bg">
                        <table  class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{\Carbon\Carbon::parse($application->appliedd_date)->format('d M,Y')}}
                                </td>
                            </tr>
                            @endforeach
                            @else
                            <tr>
                                <td colspan="3">There is not apllicants</td>
                            </tr>
                            @endif
